...
from Apps.Estudiante.views import CrearEstudiante,EliminarEstudiante,ConsultarEstudiante,ActualizarEstudiante,CrearActividad
...
urlpatterns=[
    ...
    url(r'^CrearActividad/(?P<pk>\d+)/$',CrearActividad.as_view(),name='ActualizarEstudiante'),
]
